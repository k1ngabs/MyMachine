...
$mail->Username = '4tech.social@gmail.com'; ////Usuário para autenticação 
$mail->Password = 'vtqxpjyatduxicgl'; //senha autenticação

// Remetente da mensagem - sempre usar o mesmo usuário da autenticação  
$mail->setFrom('4tech.social@gmail.com','Adm Site');
